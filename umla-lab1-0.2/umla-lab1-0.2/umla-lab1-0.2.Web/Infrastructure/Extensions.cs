namespace umla_lab1_0._2.Web.Infrastructure
{
    ...
    public static class Extensions
    {
        ...
        public static Models.CloudBlobContainer ToModel(this CloudBlobContainer container)
        {
            return new Models.CloudBlobContainer
            {
                Name = container.Name,
                Uri = container.Uri
            };
        ...
        public static void CopyRequestHeadersTo(this HttpRequest sourceRequest, WebRequest destinationRequest)
        {
            ...
            if (finalHttpWebRequest != null)
            {
                ...
                finalHttpWebRequest.KeepAlive = !string.IsNullOrWhiteSpace(connection) && connection.Equals("Close", StringComparison.OrdinalIgnoreCase) ? false : true;
